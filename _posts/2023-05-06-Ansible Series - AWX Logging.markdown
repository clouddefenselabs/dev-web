...
img: ":/2023-05-06/feat-1.png"
# disable comments on this page
comments_disable: true

# publish date
date: 2023-05-06 19:00:53 +0500
imgdate: 2023-05-06
# seo
...
![Splunk TA's for Ansible](:/{{page.imgdate}}/2.png){:data-align="center"}
...
![Splunk HTTP Event Collector](:/{{page.imgdate}}/3.png){:data-align="center"}
...
![Splunk HTTP Event Collector Settings](:/{{page.imgdate}}/4.png){:data-align="center"}

Now click "Settings" and "Add Data", on the bottom click "Monitor"

![Splunk - Monitor ](:/{{page.imgdate}}/5.png){:data-align="center"}

In the next screen click "HTTP Event Collector"

![Splunk - New HEC Token ](:/{{page.imgdate}}/6.png){:data-align="center"}
...
![Splunk - New Ansible Index ](:/{{page.imgdate}}/7.png){:data-align="center"}

On the source type click "Select" then "Structured" -> "_json".

![Splunk - New Ansible Index ](:/{{page.imgdate}}/8.png){:data-align="center"}
...
![Splunk - New Search String for Ansible Ingestion ](:/{{page.imgdate}}/9.png){:data-align="center"}
...
![AWX - System -> Logging Settings location](:/{{page.imgdate}}/10.png){:data-align="center"}

In AWX click on "Edit" on the bottom, which will allow you to edit the fields.

![AWX - Need to click Edit on bottom](:/{{page.imgdate}}/11.png){:data-align="center"}
...
![AWX - Setting up the External Logging (Before turning on switch)](:/{{page.imgdate}}/12.png){:data-align="center"}
...
![Splunk Machine - Editing Firewall Rules to accept 8088](:/{{page.imgdate}}/13.png){:data-align="center"}
...
![Splunk - AWX Data is starting to flow in](:/{{page.imgdate}}/13.png){:data-align="center"}
...
![Splunk - Searching for Ansible App](:/{{page.imgdate}}/14.png){:data-align="center"}
![Splunk - Ansible App](:/{{page.imgdate}}/15.png){:data-align="center"}
