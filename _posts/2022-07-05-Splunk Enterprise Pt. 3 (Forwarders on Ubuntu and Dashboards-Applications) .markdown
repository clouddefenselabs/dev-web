---
layout: post
title: "Splunk Enterprise Pt. 3 (Forwarders on Ubuntu and Dashboards-Applications)"
description: "Splunk - Getting data from Ubuntu into the SIEM tool"
tags: [cybersecurity, Splunk]
# thumbnail image for post
feature_image: "images/2022-07-05/feat-1.png"
# disable comments on this page
comments_disable: true
# publish date
date: 2022-07-05
imagetag: "images/2022-07-05"
# seo
...
![Splunk Download Screen]({{page.imagetag}}/2.png){:data-align="center"}

![Click above to get the wget command]({{page.imagetag}}/3.png){:data-align="center"}

![wget Command]({{page.imagetag}}/4.png){:data-align="center"}
...
![Enabled]({{page.imagetag}}/5.png){:data-align="center"}

![Started]({{page.imagetag}}/6.png){:data-align="center"}
...
![New Forwarders]({{page.imagetag}}/7.png){:data-align="center"}
...
![Splunk Homepage]({{page.imagetag}}/8.png){:data-align="center"}

From the Splunk homepage, click on “Splunk Apps” and lets search for “Windows”

![Splunk Apps]({{page.imagetag}}/9.png){:data-align="center"}

![Added]({{page.imagetag}}/10.png){:data-align="center"}
...
![Windows Personal Security]({{page.imagetag}}/11.png){:data-align="center"}
...
![Windows Personal Security Dashboard]({{page.imagetag}}/12.png){:data-align="center"}

The top bar allows you to review different data sets, for example clicking on “System”

![Windows Personal Security System]({{page.imagetag}}/13.png){:data-align="center"}

We can see there are several security log events for my Windows PC, Let’s take a look at the Application Log Events.

![Application Log Events]({{page.imagetag}}/14.png){:data-align="center"}
