...
description: "So, we’ve created our single Ubuntu virtual machine, better yet, we have created 10, 20, 100 Ubuntu Virtual machines, all from one file"
tags: [IAC, Code, homelab]
# thumbnail image for post
feature_image: "images/2022-07-19/feat-1.png"
# disable comments on this page
comments_disable: true
# publish date
date: 2022-07-19
imagetag: "images/2022-07-19"
# seo
...
<!--more-->
![I didn’t try this but I’m sure it would be fun to watch my server die a slow death.]({{page.imagetag}}/2.png){:data-align="center"}
...
![Error]({{page.imagetag}}/feat-1.png){:data-align="center"}
...
![$ terraform plan]({{page.imagetag}}/3.png){:data-align="center"}
...
![VS Code Snippet]({{page.imagetag}}/4.png){:data-align="center"}
