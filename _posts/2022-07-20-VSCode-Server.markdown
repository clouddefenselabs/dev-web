...
layout: post
title: "VSCode-Server"
description: "What if you could set up a centralized “coding server” that could access all of your servers and their code, or be able to access your github/gitea/source control repositories."
tags: [vscode, linux, homelab]
# thumbnail image for post
feature_image: "images/2022-07-20/feat-1.png"
# disable comments on this page
comments_disable: true
# publish date
date: 2022-07-20
imagetag: "images/2022-07-20"
# seo
...
![Afterward ctrl + x to save]({{page.imagetag}}/2.png){:data-align="center"}
...
```
![It's running]({{page.imagetag}}/3.png){:data-align="center"}
...
![Login Screen]({{page.imagetag}}/4.png){:data-align="center"}

Use the password we set up in our Config and now we should be able to access our server.


![Code Server Screen]({{page.imagetag}}/5.png){:data-align="center"}
