...
description: "Terraform is a CI/CD tool that has been been around for a while is an industry standard when it comes to IAC (Infrastructure as Code)"
tags: [IAC, Code, homelab]
# thumbnail image for post
feature_image: "images/2022-07-18/feat-1.png"
# disable comments on this page
comments_disable: true
# publish date
date: 2022-07-18
imagetag: "images/2022-07-18"
# seo
...
<!--more-->
![Screenshot from https://www.terraform.io/]({{page.imagetag}}/2.png){:data-align="center"}
...
![Terraform VS Code Plugin]({{page.imagetag}}/3.png){:data-align="center"}

Terraform has three main stages of deployment, an Init stage, a plan stage and an apply stage. We will start with the plans and creating a new directory for Terraform to store some configuration files (which will be also found here https://github.com/clouddefenselabs/HomeInfastructure. We will create three files, provider.tf, ubuntu-clone.tf, and credentials.auto.tfvars. A breakdown of what these are:
...
![We call out some variables that Terraform will use in provider.tf and ubuntu-clone.tf]({{page.imagetag}}/4.png){:data-align="center"}

Next let’s create our provider.tf file:

![provider.tf – code below as well]({{page.imagetag}}/5.png){:data-align="center"}
...
![It Works!]({{page.imagetag}}/6.png){:data-align="center"}
...
![Screenshot of the code, after I took this screenshot I realized I had “Count = 0” should be “Count = 1”, Corrected code snippet below:]({{page.imagetag}}/7.png){:data-align="center"}
...
![Terraform Plan]({{page.imagetag}}/8.png){:data-align="center"}

Then we simply do “Terraform Apply” and if everything is set correctly:

![After typing “terraform apply” then you confirm with “yes”]({{page.imagetag}}/9.png){:data-align="center"}
![Anxious moments]({{page.imagetag}}/10.png){:data-align="center"}
![It Works!]({{page.imagetag}}/11.png){:data-align="center"}
![I have a terminal]({{page.imagetag}}/12.png){:data-align="center"}
...
![Viola it's gone]({{page.imagetag}}/13.png){:data-align="center"}
